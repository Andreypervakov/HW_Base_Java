/* Доделать задачку с занятия:●Проверить, начинается ли ваша строка подстрокой “I like”. Используем методString.startsWith().●Найти позицию подстроки “Java” в строке “I like Java!!!”.●Заменить все символы “а” на “о”.●Преобразуйте строку к верхнему регистру.●Преобразуйте строку к нижнему регистру.●Вырезать строку Java c помощью метода String.substring().
 */
