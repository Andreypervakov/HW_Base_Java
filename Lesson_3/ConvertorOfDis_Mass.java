 /*
        ...
        величинами.
         */
public class ConvertorOfDis_Mass
{
    public static void main(String[] args)
    {
        System.out.println("Выбор конвертации :");
        String numOne = "1";
        String numTwo = "2";
    }
    chooseFist(numOne, numTwo);
    public static void chooseFist(String num)
    {
        boolean numFirst = false;
        boolean numSecond = true;
        return ();

    }
    public static void chooseSecondary()
    {   byte a = 1;
        byte b = 2;
        byte c = 3;
        byte d = 4;
    }
    public static void massConver ()
    {switch (num)
    {
